...
def classifiers_grid_search(classifier_df2, users_classifier_path, user_id, target_col='Bought Tag'):
    ...
    file_name = os.path.join(users_classifier_path, user_id + "_classifier.pkl")
    col_file_name = os.path.join(users_classifier_path, user_id + "_columns.txt")
    with open(file_name, "wb") as open_file:
        pickle.dump(best_classifier, open_file)
...
def classifiers_grid_search_all(classifier_df2, classifier_path, classifier_columns_path, target_col='Bought Tag'):
    ...
    best_classifier = best_classifiers[best_cla_id]
    """
    file_name = classifier_path
    col_file_name = classifier_columns_path
    with open(file_name, "wb") as open_file:
        pickle.dump(best_svc, open_file)
